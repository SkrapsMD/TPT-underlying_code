...
# TWT Scenario 
TWT_direct = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/TWT Data/disaggregated/disaggregated_direct_effects.csv'))
TWT_indirect = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/TWT Data/disaggregated/disaggregated_indirect_effects.csv'))
TWT_total = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/TWT Data/disaggregated/disaggregated_total_effects.csv'))

# 10% Scenario
TEN_direct = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/Constant 10%/disaggregated/disaggregated_direct_effects.csv'))
TEN_indirect = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/Constant 10%/disaggregated/disaggregated_indirect_effects.csv'))
TEN_total = pd.read_csv(os.path.join(validations_dir,'NIPA Results Validations/Constant 10%/disaggregated/disaggregated_total_effects.csv'))

def create_top20_stacked_bar_chart(direct_df, indirect_df, scenario_name, output_path, result_type="NIPA"):
    """
...
# TWT Scenario
twt_output_path = os.path.join(validations_dir, 'NIPA Results Validations/TWT Data/figures/02_top20.html')
create_top20_stacked_bar_chart(TWT_direct, TWT_indirect, "TWT Data", twt_output_path, "NIPA")

# 10% Scenario  
ten_output_path = os.path.join(validations_dir, 'NIPA Results Validations/Constant 10%/figures/02_top20.html')
create_top20_stacked_bar_chart(TEN_direct, TEN_indirect, "Constant 10%", ten_output_path, "NIPA")

...
def create_top25_product_stacked_bar_chart(direct_df, indirect_df, scenario_name, output_path, result_type="NIPA"):
    """
...
# TWT Scenario
twt_output_path = os.path.join(validations_dir, 'NIPA Results Validations/TWT Data/figures/03_top25_products.html')
create_top25_product_stacked_bar_chart(TWT_direct, TWT_indirect, "TWT Data", twt_output_path, "NIPA")

# 10% Scenario  
ten_output_path = os.path.join(validations_dir, 'NIPA Results Validations/Constant 10%/figures/03_top25_products.html')
create_top25_product_stacked_bar_chart(TEN_direct, TEN_indirect, "Constant 10%", ten_output_path, "NIPA")